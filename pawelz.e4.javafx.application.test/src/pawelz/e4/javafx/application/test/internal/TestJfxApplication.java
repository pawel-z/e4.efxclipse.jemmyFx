package pawelz.e4.javafx.application.test.internal;
...
import pawelz.e4.javafx.application.test.Activator;
import at.bestsolution.efxclipse.runtime.application.AbstractJFXApplication;

//import rec.demo.rcp.e4.javafx.app.Activator;

/**
 * This class is exactly the same as E4Application class from the
 * at.bestsolution.efxclipse.runtime.workbench.fx project. <br>
 * <br>
 * FIXME: E4Application should be exported in MANIFEST.MF. Then we can delete
 * this TestJfxApplication class.
 * 
 * 
 */
public class TestJfxApplication extends AbstractJFXApplication {
